...
public class StatusData {
	 ...
	 public void insert(Status status){
		 ...
		 // db.insert(TABLE, null, values);  // THIS LINE here is commeted cause _id should be unique and that will be cause issue with
		 									// database and will start throwing errors so we need to handle it and the method for that is insertWithOnConflict
	 ...
	 public Cursor query(){
		 ...
		 Cursor cursor = db.query(TABLE, null, null, null, null, null, C_CREATED_AT + " DESC"); // select * from status order by  created_at DESC
		 return cursor; 
	 }
